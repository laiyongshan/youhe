...
extern "C"
jstring
Java_com_example_youhe_youhecheguanjia_utils_ParamSign_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
    //MD5 md5;
...
extern "C"
jstring
Java_com_example_youhe_youhecheguanjia_utils_ParamSign_getUserPasswordFromJNI(
        JNIEnv* env,
        jobject obj,
        jstring jstr) {
...
extern "C"
jstring
Java_com_example_youhe_youhecheguanjia_utils_ParamSign_getFromJNI(
        JNIEnv* env,
        jobject obj,
        jstring jstr) {
...
extern "C"
jstring
Java_com_example_youhe_youhecheguanjia_utils_ParamSign_encryptDES(JNIEnv *env, jobject instance, jstring msg_) {
...
extern "C"
jstring
Java_com_example_youhe_youhecheguanjia_utils_ParamSign_decryptDES(JNIEnv *env, jobject instance, jstring msg_) {
