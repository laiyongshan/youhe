...
public class DetectionOfUpdate2 {
    ...
    public DetectionOfUpdate2(Activity activity) {
...
//        phonePams.put("token", token);
     ...
     * @param url
     */
    private DetectionOfUpdate2.MAsyncTask tas;
    ...
    public void doLoginDialog(final String url) {
        ...
        builder.setPositiveButton("是", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                downloadDialog.show();
                tas = new DetectionOfUpdate2.MAsyncTask(url);
                tas.execute();
