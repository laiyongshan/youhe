...
import com.example.youhe.youhecheguanjia.bean.Trace;
...
public class TraceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == TYPE_TOP) {
            ...
            // 字体颜色加深
            itemHolder.tvAcceptTime.setTextColor(context.getColor(R.color.new_color_primary));
            itemHolder.tvAcceptStation.setTextColor(context.getColor(R.color.new_color_primary));
