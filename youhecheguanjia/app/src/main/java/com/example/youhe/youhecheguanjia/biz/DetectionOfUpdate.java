...
import com.example.youhe.youhecheguanjia.db.biz.VersionSQLUtils;
import com.example.youhe.youhecheguanjia.dialog.UIDialog;
import com.example.youhe.youhecheguanjia.https.URLs;
import com.example.youhe.youhecheguanjia.logic.VolleyInterface;
import com.example.youhe.youhecheguanjia.widget.DownloadTheAPP;
...
//        phonePams.put("token", token);
     ...
     * @param url
     */
    private DetectionOfUpdate.MAsyncTask tas;
        ...
        protected void onPostExecute(File file) {
            ...
            if (file != null) {
                ...
                if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.N){
                    ...
                    Uri contentUri= FileProvider.getUriForFile(activity,"com.example.youhe.youhecheguanjia.fileprovider",file);
    ...
    public void doLoginDialog(final String url) {
        ...
        builder.setPositiveButton("是", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                downloadDialog.show();
                tas = new DetectionOfUpdate.MAsyncTask(url);
                tas.execute();
