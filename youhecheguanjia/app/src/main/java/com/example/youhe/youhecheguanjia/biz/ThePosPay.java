...
public class ThePosPay {
    ...
    public static int postype;//1:P8，2:P92(暂时还没有)，3：M60-A

    public static String sendSecretKey;//M60-A机器的工作密钥

    public static void setSendSecretKey(String sendSecretKey) {
        ThePosPay.sendSecretKey = sendSecretKey;
    }

    public static String getSendSecretKey() {
        return sendSecretKey;
    }
