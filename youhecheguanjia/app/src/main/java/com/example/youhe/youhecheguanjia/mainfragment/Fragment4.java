...
import com.example.youhe.youhecheguanjia.biz.DetectionOfUpdate;
...
//                }
        ...
        view.findViewById(R.id.request_refund_layout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String status = statusSQLUtils.check();
                if (status.equals("yes")) {
                    Intent intent = new Intent(getActivity(), Apply_for_Crash_Activity.class);
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(getActivity(), DenLuActivity.class);
                    startActivity(intent);
...
//        Bitmap bitmap = BitmapFactory.decodeFile("/sdcard/" + "touxian" + ".png");
        //显示SD卡中的图片缓存
