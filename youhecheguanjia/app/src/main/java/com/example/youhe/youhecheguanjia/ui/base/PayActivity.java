...
import com.example.youhe.youhecheguanjia.adapter.PayStyleAdapter;
import com.example.youhe.youhecheguanjia.app.CommentSetting;
import com.example.youhe.youhecheguanjia.bean.Paytype;
...
import com.example.youhe.youhecheguanjia.utils.ListViewHeightUtil;
...
//                Intent intent=new Intent(PayActivity.this,VPosPayActivty.class);
...
//                }
    ...
    //获取支付通道
    public void getPaytype(final Context context, String ordercode) {
        ...
        VolleyUtil.getVolleyUtil(context).StringRequestPostVolley(URLs.GET_PAY_TYPE, EncryptUtil.encrypt(map), new VolleyInterface() {
            ...
            public void ResponseResult(Object jsonObject){
                ...
                try {
                    ...
                    if(dataObj.has("postype")){
                        ThePosPay.postype=dataObj.optInt("postype");
                        Log.i("TAG","postype>>>>>>>>>>"+ThePosPay.postype);
                    }

                    if(dataObj.has("sendSecretKey")){
                        ThePosPay.sendSecretKey=dataObj.optString("sendSecretKey");
                        Log.i("TAG","postype>>>>>>>>>>"+ThePosPay.sendSecretKey);
                    }
