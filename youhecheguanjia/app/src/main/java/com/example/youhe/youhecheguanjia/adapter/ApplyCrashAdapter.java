...
import com.example.youhe.youhecheguanjia.bean.ApplyCrashItem;
...
//        if(withdrawals_list.get(i).getStatus().equals("完成")) {
...
//            holder.to_the_account_tv.setVisibility(View.INVISIBLE);
//            holder.withdrawal_fee_tv.setVisibility(View.INVISIBLE);
//        }
        return convertView;
    }
