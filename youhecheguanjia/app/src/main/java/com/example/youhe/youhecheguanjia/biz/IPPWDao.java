...
import com.example.youhe.youhecheguanjia.dialog.PswDialog;
import com.example.youhe.youhecheguanjia.https.URLs;
import com.example.youhe.youhecheguanjia.logic.VolleyInterface;
import com.example.youhe.youhecheguanjia.ui.base.ApplyCrashActivity;
        ...
        try {
            ...
            if (status.equals("ok")) {
                ...
                if (payType==1) {//汇聚支付
                  ...
                  if(ThePosPay.postype==1) {//P8
//                      payintent.setClass(mActivity, VPosPayActivty.class);
                      payintent.setClass(mActivity, NewJoinpayActivity.class);
                  }else if(ThePosPay.postype==2){//P92
                      payintent.setClass(mActivity,P92PayActivity.class);
                  } else if(ThePosPay.postype==3){//M60
                      payintent.setClass(mActivity, M60PayActivity.class);
                      payintent.putExtra("sendSecretKey",ThePosPay.sendSecretKey+"");
                  }else if(ThePosPay.postype==4){//Vpos
                      payintent.setClass(mActivity, VPosPayActivty.class);
                  }
